...
module AESL_automem_Xj_f_M_imag (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.music.autotvin_Xj_f_M_imag.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.music.autotvout_Xj_f_M_imag.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 16;
parameter DEPTH = 32'd 40960;
parameter DLY = 0.1;
