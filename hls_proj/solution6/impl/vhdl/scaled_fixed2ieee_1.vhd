...
architecture behav of scaled_fixed2ieee_1 is 
    ...
    signal empty_61_fu_416_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component scaled_fixed2ieeeThq IS
    generic (
        DataWidth : INTEGER;
    ...
    component scaled_fixed2ieeeUhA IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    out_bits_V_U : component scaled_fixed2ieeeThq
    generic map (
        DataWidth => 32,
        AddressRange => 2,
        AddressWidth => 1)
    ...
    c_U : component scaled_fixed2ieeeUhA
    generic map (
        DataWidth => 32,
        AddressRange => 2,
        AddressWidth => 1)
    ...
    empty_61_fu_416_p1 <= newexp_fu_397_p2(8 - 1 downto 0);
