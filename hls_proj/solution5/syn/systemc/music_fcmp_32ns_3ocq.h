...
// ==============================================================
#ifndef __music_fcmp_32ns_3ocq__HH__
#define __music_fcmp_32ns_3ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fcmp_32ns_3ocq) {
    ...
    SC_CTOR(music_fcmp_32ns_3ocq):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
