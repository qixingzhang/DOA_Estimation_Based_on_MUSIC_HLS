...
qrf_givens_float_s::qrf_givens_float_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    music_fadd_32ns_3ocq_U80->din0(reg_353);
    music_fadd_32ns_3ocq_U80->din1(grp_fu_234_p1);
    music_fadd_32ns_3ocq_U80->ce(grp_fu_234_ce);
    music_fadd_32ns_3ocq_U80->dout(grp_fu_234_p2);
    ...
    music_fadd_32ns_3ocq_U81->din0(reg_358);
    music_fadd_32ns_3ocq_U81->din1(ap_var_for_const0);
    music_fadd_32ns_3ocq_U81->ce(grp_fu_238_ce);
    music_fadd_32ns_3ocq_U81->dout(grp_fu_238_p2);
    music_fsub_32ns_3rcU_U82 = new music_fsub_32ns_3rcU<1,5,32,32,32>("music_fsub_32ns_3rcU_U82");
    music_fsub_32ns_3rcU_U82->clk(ap_clk);
    music_fsub_32ns_3rcU_U82->reset(ap_rst);
    music_fsub_32ns_3rcU_U82->din0(reg_363);
    music_fsub_32ns_3rcU_U82->din1(grp_fu_243_p1);
    music_fsub_32ns_3rcU_U82->ce(grp_fu_243_ce);
    music_fsub_32ns_3rcU_U82->dout(grp_fu_243_p2);
    music_fadd_32ns_3ocq_U83 = new music_fadd_32ns_3ocq<1,5,32,32,32>("music_fadd_32ns_3ocq_U83");
    music_fadd_32ns_3ocq_U83->clk(ap_clk);
    music_fadd_32ns_3ocq_U83->reset(ap_rst);
    music_fadd_32ns_3ocq_U83->din0(tmp_i_i8_reg_1062);
    music_fadd_32ns_3ocq_U83->din1(tmp_i_i5_reg_1052_pp0_iter53_reg);
    music_fadd_32ns_3ocq_U83->ce(grp_fu_247_ce);
    music_fadd_32ns_3ocq_U83->dout(grp_fu_247_p2);
    music_fsub_32ns_3rcU_U84 = new music_fsub_32ns_3rcU<1,5,32,32,32>("music_fsub_32ns_3rcU_U84");
    music_fsub_32ns_3rcU_U84->clk(ap_clk);
    music_fsub_32ns_3rcU_U84->reset(ap_rst);
    music_fsub_32ns_3rcU_U84->din0(tmp_5_i_i2_reg_1067);
    music_fsub_32ns_3rcU_U84->din1(tmp_6_i_i2_reg_1057_pp0_iter53_reg);
    music_fsub_32ns_3rcU_U84->ce(grp_fu_251_ce);
    music_fsub_32ns_3rcU_U84->dout(grp_fu_251_p2);
    ...
    music_fmul_32ns_3jbC_U85->din0(b_M_imag_read_reg_868_pp0_iter1_reg);
    music_fmul_32ns_3jbC_U85->din1(ap_var_for_const0);
    music_fmul_32ns_3jbC_U85->ce(grp_fu_255_ce);
    music_fmul_32ns_3jbC_U85->dout(grp_fu_255_p2);
    ...
    music_fmul_32ns_3jbC_U86->din0(b_M_real_read_reg_879_pp0_iter1_reg);
    music_fmul_32ns_3jbC_U86->din1(ap_var_for_const0);
    music_fmul_32ns_3jbC_U86->ce(grp_fu_260_ce);
    music_fmul_32ns_3jbC_U86->dout(grp_fu_260_p2);
    ...
    music_fmul_32ns_3jbC_U87->din0(a_M_imag_read_reg_889_pp0_iter3_reg);
    music_fmul_32ns_3jbC_U87->din1(ap_var_for_const0);
    music_fmul_32ns_3jbC_U87->ce(grp_fu_265_ce);
    music_fmul_32ns_3jbC_U87->dout(grp_fu_265_p2);
    ...
    music_fmul_32ns_3jbC_U88->din0(a_M_real_read_reg_897_pp0_iter3_reg);
    music_fmul_32ns_3jbC_U88->din1(ap_var_for_const0);
    music_fmul_32ns_3jbC_U88->ce(grp_fu_270_ce);
    music_fmul_32ns_3jbC_U88->dout(grp_fu_270_p2);
    ...
    music_fmul_32ns_3jbC_U89->din0(b_M_imag_read_reg_868_pp0_iter3_reg);
    music_fmul_32ns_3jbC_U89->din1(ap_var_for_const0);
    music_fmul_32ns_3jbC_U89->ce(grp_fu_275_ce);
    music_fmul_32ns_3jbC_U89->dout(grp_fu_275_p2);
    ...
    music_fmul_32ns_3jbC_U90->din0(b_M_real_read_reg_879_pp0_iter3_reg);
    music_fmul_32ns_3jbC_U90->din1(ap_var_for_const0);
    music_fmul_32ns_3jbC_U90->ce(grp_fu_280_ce);
    music_fmul_32ns_3jbC_U90->dout(grp_fu_280_p2);
    ...
    music_fmul_32ns_3jbC_U91->din0(reg_341);
    music_fmul_32ns_3jbC_U91->din1(grp_fu_285_p1);
    music_fmul_32ns_3jbC_U91->ce(grp_fu_285_ce);
    music_fmul_32ns_3jbC_U91->dout(grp_fu_285_p2);
    ...
    music_fmul_32ns_3jbC_U92->din1(reg_341);
    music_fmul_32ns_3jbC_U92->ce(grp_fu_289_ce);
    music_fmul_32ns_3jbC_U92->dout(grp_fu_289_p2);
    ...
    music_fmul_32ns_3jbC_U93->din1(grp_fu_293_p1);
    music_fmul_32ns_3jbC_U93->ce(grp_fu_293_ce);
    music_fmul_32ns_3jbC_U93->dout(grp_fu_293_p2);
    ...
    music_fmul_32ns_3jbC_U94->din1(b_M_real_read_reg_879_pp0_iter49_reg);
    music_fmul_32ns_3jbC_U94->ce(grp_fu_297_ce);
    music_fmul_32ns_3jbC_U94->dout(grp_fu_297_p2);
    ...
    music_fmul_32ns_3jbC_U95->din1(b_M_imag_read_reg_868_pp0_iter49_reg);
    music_fmul_32ns_3jbC_U95->ce(grp_fu_301_ce);
    music_fmul_32ns_3jbC_U95->dout(grp_fu_301_p2);
    music_fdiv_32ns_3ncg_U96 = new music_fdiv_32ns_3ncg<1,16,32,32,32>("music_fdiv_32ns_3ncg_U96");
    music_fdiv_32ns_3ncg_U96->clk(ap_clk);
    music_fdiv_32ns_3ncg_U96->reset(ap_rst);
    music_fdiv_32ns_3ncg_U96->din0(reg_368);
    music_fdiv_32ns_3ncg_U96->din1(reg_373);
    music_fdiv_32ns_3ncg_U96->ce(grp_fu_305_ce);
    music_fdiv_32ns_3ncg_U96->dout(grp_fu_305_p2);
    ...
    music_fdiv_32ns_3ncg_U97->din0(reg_381);
    music_fdiv_32ns_3ncg_U97->din1(reg_373);
    music_fdiv_32ns_3ncg_U97->ce(grp_fu_309_ce);
    music_fdiv_32ns_3ncg_U97->dout(grp_fu_309_p2);
    ...
    music_fdiv_32ns_3ncg_U98->din0(tmp_2_i_i5_reg_1072);
    music_fdiv_32ns_3ncg_U98->din1(reg_373);
    music_fdiv_32ns_3ncg_U98->ce(grp_fu_313_ce);
    music_fdiv_32ns_3ncg_U98->dout(grp_fu_313_p2);
    ...
    music_fdiv_32ns_3ncg_U99->din0(tmp_7_i_i2_reg_1077);
    music_fdiv_32ns_3ncg_U99->din1(reg_373);
    music_fdiv_32ns_3ncg_U99->ce(grp_fu_317_ce);
    music_fdiv_32ns_3ncg_U99->dout(grp_fu_317_p2);
    music_fcmp_32ns_3pcA_U100 = new music_fcmp_32ns_3pcA<1,2,32,32,1>("music_fcmp_32ns_3pcA_U100");
    music_fcmp_32ns_3pcA_U100->clk(ap_clk);
    music_fcmp_32ns_3pcA_U100->reset(ap_rst);
    music_fcmp_32ns_3pcA_U100->din0(grp_fu_321_p0);
    music_fcmp_32ns_3pcA_U100->din1(ap_var_for_const0);
    music_fcmp_32ns_3pcA_U100->ce(grp_fu_321_ce);
    music_fcmp_32ns_3pcA_U100->opcode(ap_var_for_const1);
    music_fcmp_32ns_3pcA_U100->dout(grp_fu_321_p2);
    ...
    music_fcmp_32ns_3pcA_U101->din0(grp_fu_326_p0);
    music_fcmp_32ns_3pcA_U101->din1(ap_var_for_const0);
    music_fcmp_32ns_3pcA_U101->ce(grp_fu_326_ce);
    music_fcmp_32ns_3pcA_U101->opcode(ap_var_for_const1);
    music_fcmp_32ns_3pcA_U101->dout(grp_fu_326_p2);
    ...
    music_fcmp_32ns_3pcA_U102->din0(grp_fu_331_p0);
    music_fcmp_32ns_3pcA_U102->din1(ap_var_for_const0);
    music_fcmp_32ns_3pcA_U102->ce(grp_fu_331_ce);
    music_fcmp_32ns_3pcA_U102->opcode(ap_var_for_const1);
    music_fcmp_32ns_3pcA_U102->dout(grp_fu_331_p2);
    ...
    music_fcmp_32ns_3pcA_U103->din0(grp_fu_336_p0);
    music_fcmp_32ns_3pcA_U103->din1(ap_var_for_const0);
    music_fcmp_32ns_3pcA_U103->ce(grp_fu_336_ce);
    music_fcmp_32ns_3pcA_U103->opcode(ap_var_for_const1);
    music_fcmp_32ns_3pcA_U103->dout(grp_fu_336_p2);
...
qrf_givens_float_s::~qrf_givens_float_s() {
    ...
    delete music_fsub_32ns_3rcU_U82;
    delete music_fadd_32ns_3ocq_U83;
    delete music_fsub_32ns_3rcU_U84;
