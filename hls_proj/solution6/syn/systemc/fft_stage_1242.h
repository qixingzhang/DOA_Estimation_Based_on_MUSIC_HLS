...
#ifndef _fft_stage_1242_HH_
#define _fft_stage_1242_HH_
...
struct fft_stage_1242 : public sc_module {
    ...
    sc_out< sc_lv<10> > X_R_6_address1;
    sc_out< sc_logic > X_R_6_ce1;
    sc_in< sc_lv<32> > X_R_6_q1;
    sc_out< sc_lv<10> > X_I_6_address0;
    sc_out< sc_logic > X_I_6_ce0;
    sc_in< sc_lv<32> > X_I_6_q0;
    sc_out< sc_lv<10> > X_I_6_address1;
    sc_out< sc_logic > X_I_6_ce1;
    sc_in< sc_lv<32> > X_I_6_q1;
    ...
    // Module declarations
    fft_stage_1242(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_1242);

    ~fft_stage_1242();

    sc_trace_file* mVcdFile;

    fft_stage_1237_W_eOg* W_real272_U;
    fft_stage_1237_W_fYi* W_imag264_U;
    music_fsub_32ns_3bkb<1,5,32,32,32>* music_fsub_32ns_3bkb_U92;
    music_fadd_32ns_3cud<1,5,32,32,32>* music_fadd_32ns_3cud_U93;
    music_fsub_32ns_3bkb<1,5,32,32,32>* music_fsub_32ns_3bkb_U94;
    music_fsub_32ns_3bkb<1,5,32,32,32>* music_fsub_32ns_3bkb_U95;
    music_fadd_32ns_3cud<1,5,32,32,32>* music_fadd_32ns_3cud_U96;
    music_fadd_32ns_3cud<1,5,32,32,32>* music_fadd_32ns_3cud_U97;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U98;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U99;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U100;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U101;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<3> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<9> > W_real272_address0;
    sc_signal< sc_logic > W_real272_ce0;
    sc_signal< sc_lv<32> > W_real272_q0;
    sc_signal< sc_lv<9> > W_imag264_address0;
    sc_signal< sc_logic > W_imag264_ce0;
    sc_signal< sc_lv<32> > W_imag264_q0;
    ...
    sc_signal< sc_lv<7> > select_ln145_6_fu_331_p3;
    sc_signal< sc_lv<7> > select_ln145_6_reg_393;
    ...
    sc_signal< sc_lv<4> > t_fu_363_p2;
    sc_signal< sc_lv<32> > W_real272_load_reg_424;
    sc_signal< sc_lv<32> > W_imag264_load_reg_430;
    sc_signal< sc_lv<32> > X_R_6_load_reg_436;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< sc_lv<32> > X_I_6_load_reg_442;
    ...
    sc_signal< sc_lv<32> > tmp_61_reg_458;
    sc_signal< sc_lv<32> > grp_fu_257_p2;
    sc_signal< sc_lv<32> > tmp_62_reg_463;
    ...
    sc_signal< sc_lv<32> > X_R_6_load_1_reg_496;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter10;
    sc_signal< sc_lv<32> > X_I_6_load_1_reg_502;
    sc_signal< sc_lv<32> > grp_fu_229_p2;
    sc_signal< sc_lv<32> > tmp_63_reg_508;
    sc_signal< sc_lv<32> > grp_fu_233_p2;
    sc_signal< sc_lv<32> > tmp_64_reg_513;
    sc_signal< sc_lv<32> > grp_fu_237_p2;
    sc_signal< sc_lv<32> > tmp_65_reg_518;
    sc_signal< sc_lv<32> > grp_fu_241_p2;
    sc_signal< sc_lv<32> > tmp_66_reg_523;
    ...
    sc_signal< sc_lv<6> > trunc_ln152_fu_261_p1;
    sc_signal< sc_lv<1> > icmp_ln148_fu_291_p2;
    sc_signal< sc_lv<7> > j_fu_285_p2;
    sc_signal< sc_lv<6> > trunc_ln152_3_fu_305_p1;
    sc_signal< sc_lv<9> > k_mid1_fu_309_p3;
    sc_signal< sc_lv<9> > k_fu_265_p3;
    sc_signal< sc_lv<9> > select_ln145_5_fu_317_p3;
    sc_signal< sc_lv<4> > select_ln145_fu_297_p3;
    sc_signal< sc_lv<3> > trunc_ln149_fu_339_p1;
    ...
    void thread_W_imag264_address0();
    void thread_W_imag264_ce0();
    void thread_W_real272_address0();
    void thread_W_real272_ce0();
    void thread_X_I_6_address0();
    void thread_X_I_6_address1();
    void thread_X_I_6_ce0();
    void thread_X_I_6_ce1();
    void thread_X_R_6_address0();
    void thread_X_R_6_address1();
    void thread_X_R_6_ce0();
    void thread_X_R_6_ce1();
    ...
    void thread_select_ln145_5_fu_317_p3();
    void thread_select_ln145_6_fu_331_p3();
    void thread_select_ln145_fu_297_p3();
    void thread_t_fu_363_p2();
    void thread_trunc_ln149_fu_339_p1();
    void thread_trunc_ln152_3_fu_305_p1();
