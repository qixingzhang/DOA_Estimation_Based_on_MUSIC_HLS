...
// ==============================================================
#ifndef __music_mul_mul_15nibs__HH__
#define __music_mul_mul_15nibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_mul_15nibs) {
    ...
    SC_CTOR(music_mul_mul_15nibs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
