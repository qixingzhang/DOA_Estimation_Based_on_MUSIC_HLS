...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "music.autotvin.dat"
	set constFileTvOut       "music.autotvout.dat"
	set constFileHdlTvIn     "music.autohdltvin.dat"
	set constFileHdlTvOut    "music.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
