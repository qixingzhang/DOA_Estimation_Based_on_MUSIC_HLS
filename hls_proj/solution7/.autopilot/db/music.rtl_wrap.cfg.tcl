...
set Pointer1 "0"
set Reference1 "0"
set Dims1 [list 10240 4]
set Interface1 "wire"
set DataType1 "float"
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "data_im"
set BitWidth2 "64"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
...
set DataType3 [list "out_stream" "struct out_stream" $structMem3 1 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
