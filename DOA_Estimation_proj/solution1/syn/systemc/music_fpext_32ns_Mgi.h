...
// ==============================================================
#ifndef __music_fpext_32ns_Mgi__HH__
#define __music_fpext_32ns_Mgi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fpext_32ns_Mgi) {
    ...
    SC_CTOR(music_fpext_32ns_Mgi):  ACMP_fpext_U ("ACMP_fpext_U") {
