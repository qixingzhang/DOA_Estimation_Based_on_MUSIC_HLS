...
// ==============================================================
#ifndef __music_mul_64s_63nbrm__HH__
#define __music_mul_64s_63nbrm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_64s_63nbrm) {
    ...
    SC_CTOR(music_mul_64s_63nbrm):  ACMP_mul_su_U ("ACMP_mul_su_U") {
