...
// ==============================================================
#ifndef __sin_or_cos_float_dEe_H__
#define __sin_or_cos_float_dEe_H__
...
struct sin_or_cos_float_dEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sin_or_cos_float_dEe_ram) {
...
SC_MODULE(sin_or_cos_float_dEe) {
...
sin_or_cos_float_dEe_ram* meminst;


SC_CTOR(sin_or_cos_float_dEe) {
meminst = new sin_or_cos_float_dEe_ram("sin_or_cos_float_dEe_ram");
