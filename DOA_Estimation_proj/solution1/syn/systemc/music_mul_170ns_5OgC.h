...
// ==============================================================
#ifndef __music_mul_170ns_5OgC__HH__
#define __music_mul_170ns_5OgC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_170ns_5OgC) {
    ...
    SC_CTOR(music_mul_170ns_5OgC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
