...
const sc_logic fft_stage_1241::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic fft_stage_1241::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<3> fft_stage_1241::ap_ST_fsm_state1 = "1";
const sc_lv<3> fft_stage_1241::ap_ST_fsm_pp0_stage0 = "10";
const sc_lv<3> fft_stage_1241::ap_ST_fsm_state19 = "100";
const sc_lv<32> fft_stage_1241::ap_const_lv32_0 = "00000000000000000000000000000000";
const bool fft_stage_1241::ap_const_boolean_1 = true;
const sc_lv<32> fft_stage_1241::ap_const_lv32_1 = "1";
const bool fft_stage_1241::ap_const_boolean_0 = false;
const sc_lv<1> fft_stage_1241::ap_const_lv1_0 = "0";
const sc_lv<1> fft_stage_1241::ap_const_lv1_1 = "1";
const sc_lv<10> fft_stage_1241::ap_const_lv10_0 = "0000000000";
const sc_lv<6> fft_stage_1241::ap_const_lv6_0 = "000000";
const sc_lv<5> fft_stage_1241::ap_const_lv5_0 = "00000";
const sc_lv<4> fft_stage_1241::ap_const_lv4_0 = "0000";
const sc_lv<10> fft_stage_1241::ap_const_lv10_200 = "1000000000";
const sc_lv<10> fft_stage_1241::ap_const_lv10_1 = "1";
const sc_lv<6> fft_stage_1241::ap_const_lv6_1 = "1";
const sc_lv<5> fft_stage_1241::ap_const_lv5_10 = "10000";
const sc_lv<10> fft_stage_1241::ap_const_lv10_20 = "100000";
const sc_lv<5> fft_stage_1241::ap_const_lv5_1 = "1";
const sc_lv<32> fft_stage_1241::ap_const_lv32_2 = "10";

fft_stage_1241::fft_stage_1241(sc_module_name name) : sc_module(name), mVcdFile(0) {
    W_real273_U = new fft_stage_1237_W_eOg("W_real273_U");
    W_real273_U->clk(ap_clk);
    W_real273_U->reset(ap_rst);
    W_real273_U->address0(W_real273_address0);
    W_real273_U->ce0(W_real273_ce0);
    W_real273_U->q0(W_real273_q0);
    W_imag265_U = new fft_stage_1237_W_fYi("W_imag265_U");
    W_imag265_U->clk(ap_clk);
    W_imag265_U->reset(ap_rst);
    W_imag265_U->address0(W_imag265_address0);
    W_imag265_U->ce0(W_imag265_ce0);
    W_imag265_U->q0(W_imag265_q0);
    music_fsub_32ns_3bkb_U78 = new music_fsub_32ns_3bkb<1,5,32,32,32>("music_fsub_32ns_3bkb_U78");
    music_fsub_32ns_3bkb_U78->clk(ap_clk);
    music_fsub_32ns_3bkb_U78->reset(ap_rst);
    music_fsub_32ns_3bkb_U78->din0(tmp_reg_448);
    music_fsub_32ns_3bkb_U78->din1(tmp_s_reg_453);
    music_fsub_32ns_3bkb_U78->ce(ap_var_for_const0);
    music_fsub_32ns_3bkb_U78->dout(grp_fu_221_p2);
    music_fadd_32ns_3cud_U79 = new music_fadd_32ns_3cud<1,5,32,32,32>("music_fadd_32ns_3cud_U79");
    music_fadd_32ns_3cud_U79->clk(ap_clk);
    music_fadd_32ns_3cud_U79->reset(ap_rst);
    music_fadd_32ns_3cud_U79->din0(tmp_62_reg_458);
    music_fadd_32ns_3cud_U79->din1(tmp_63_reg_463);
    music_fadd_32ns_3cud_U79->ce(ap_var_for_const0);
    music_fadd_32ns_3cud_U79->dout(grp_fu_225_p2);
    music_fsub_32ns_3bkb_U80 = new music_fsub_32ns_3bkb<1,5,32,32,32>("music_fsub_32ns_3bkb_U80");
    music_fsub_32ns_3bkb_U80->clk(ap_clk);
    music_fsub_32ns_3bkb_U80->reset(ap_rst);
    music_fsub_32ns_3bkb_U80->din0(X_R_5_load_1_reg_496);
    music_fsub_32ns_3bkb_U80->din1(temp_R_reg_484);
    music_fsub_32ns_3bkb_U80->ce(ap_var_for_const0);
    music_fsub_32ns_3bkb_U80->dout(grp_fu_229_p2);
    music_fsub_32ns_3bkb_U81 = new music_fsub_32ns_3bkb<1,5,32,32,32>("music_fsub_32ns_3bkb_U81");
    music_fsub_32ns_3bkb_U81->clk(ap_clk);
    music_fsub_32ns_3bkb_U81->reset(ap_rst);
    music_fsub_32ns_3bkb_U81->din0(X_I_5_load_1_reg_502);
    music_fsub_32ns_3bkb_U81->din1(temp_I_reg_490);
    music_fsub_32ns_3bkb_U81->ce(ap_var_for_const0);
    music_fsub_32ns_3bkb_U81->dout(grp_fu_233_p2);
    music_fadd_32ns_3cud_U82 = new music_fadd_32ns_3cud<1,5,32,32,32>("music_fadd_32ns_3cud_U82");
    music_fadd_32ns_3cud_U82->clk(ap_clk);
    music_fadd_32ns_3cud_U82->reset(ap_rst);
    music_fadd_32ns_3cud_U82->din0(X_R_5_load_1_reg_496);
    music_fadd_32ns_3cud_U82->din1(temp_R_reg_484);
    music_fadd_32ns_3cud_U82->ce(ap_var_for_const0);
    music_fadd_32ns_3cud_U82->dout(grp_fu_237_p2);
    music_fadd_32ns_3cud_U83 = new music_fadd_32ns_3cud<1,5,32,32,32>("music_fadd_32ns_3cud_U83");
    music_fadd_32ns_3cud_U83->clk(ap_clk);
    music_fadd_32ns_3cud_U83->reset(ap_rst);
    music_fadd_32ns_3cud_U83->din0(X_I_5_load_1_reg_502);
    music_fadd_32ns_3cud_U83->din1(temp_I_reg_490);
    music_fadd_32ns_3cud_U83->ce(ap_var_for_const0);
    music_fadd_32ns_3cud_U83->dout(grp_fu_241_p2);
    music_fmul_32ns_3dEe_U84 = new music_fmul_32ns_3dEe<1,4,32,32,32>("music_fmul_32ns_3dEe_U84");
    music_fmul_32ns_3dEe_U84->clk(ap_clk);
    music_fmul_32ns_3dEe_U84->reset(ap_rst);
    music_fmul_32ns_3dEe_U84->din0(X_R_5_load_reg_436);
    music_fmul_32ns_3dEe_U84->din1(W_real273_load_reg_424);
    music_fmul_32ns_3dEe_U84->ce(ap_var_for_const0);
    music_fmul_32ns_3dEe_U84->dout(grp_fu_245_p2);
    music_fmul_32ns_3dEe_U85 = new music_fmul_32ns_3dEe<1,4,32,32,32>("music_fmul_32ns_3dEe_U85");
    music_fmul_32ns_3dEe_U85->clk(ap_clk);
    music_fmul_32ns_3dEe_U85->reset(ap_rst);
    music_fmul_32ns_3dEe_U85->din0(X_I_5_load_reg_442);
    music_fmul_32ns_3dEe_U85->din1(W_imag265_load_reg_430);
    music_fmul_32ns_3dEe_U85->ce(ap_var_for_const0);
    music_fmul_32ns_3dEe_U85->dout(grp_fu_249_p2);
    music_fmul_32ns_3dEe_U86 = new music_fmul_32ns_3dEe<1,4,32,32,32>("music_fmul_32ns_3dEe_U86");
    music_fmul_32ns_3dEe_U86->clk(ap_clk);
    music_fmul_32ns_3dEe_U86->reset(ap_rst);
    music_fmul_32ns_3dEe_U86->din0(X_I_5_load_reg_442);
    music_fmul_32ns_3dEe_U86->din1(W_real273_load_reg_424);
    music_fmul_32ns_3dEe_U86->ce(ap_var_for_const0);
    music_fmul_32ns_3dEe_U86->dout(grp_fu_253_p2);
    music_fmul_32ns_3dEe_U87 = new music_fmul_32ns_3dEe<1,4,32,32,32>("music_fmul_32ns_3dEe_U87");
    music_fmul_32ns_3dEe_U87->clk(ap_clk);
    music_fmul_32ns_3dEe_U87->reset(ap_rst);
    music_fmul_32ns_3dEe_U87->din0(X_R_5_load_reg_436);
    music_fmul_32ns_3dEe_U87->din1(W_imag265_load_reg_430);
    music_fmul_32ns_3dEe_U87->ce(ap_var_for_const0);
    music_fmul_32ns_3dEe_U87->dout(grp_fu_257_p2);
    ...
    SC_METHOD(thread_W_imag265_address0);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( zext_ln145_fu_325_p1 );

    SC_METHOD(thread_W_imag265_ce0);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );

    SC_METHOD(thread_W_real273_address0);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( zext_ln145_fu_325_p1 );

    SC_METHOD(thread_W_real273_ce0);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    SC_METHOD(thread_X_I_5_address1);
    ...
    SC_METHOD(thread_X_R_5_address1);
    sensitive << ( zext_ln158_fu_369_p1 );
    sensitive << ( ap_enable_reg_pp0_iter9 );
    sensitive << ( ap_block_pp0_stage0 );
    ...
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( select_ln145_9_reg_393 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( ap_block_pp0_stage0 );
    ...
    sensitive << ( select_ln145_9_fu_331_p3 );
    ...
    sensitive << ( trunc_ln152_4_fu_305_p1 );

    SC_METHOD(thread_select_ln145_8_fu_317_p3);
    sensitive << ( icmp_ln148_fu_291_p2 );
    sensitive << ( k_mid1_fu_309_p3 );
    sensitive << ( k_fu_265_p3 );

    SC_METHOD(thread_select_ln145_9_fu_331_p3);
    sensitive << ( ap_phi_mux_j_0_phi_fu_203_p4 );
    sensitive << ( icmp_ln148_fu_291_p2 );
    ...
    SC_METHOD(thread_trunc_ln152_4_fu_305_p1);
    sensitive << ( j_fu_285_p2 );
    ...
    sensitive << ( select_ln145_8_fu_317_p3 );
    ...
    apTFilenSS << "fft_stage_1241_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, X_R_5_address1, "(port)X_R_5_address1");
    sc_trace(mVcdFile, X_R_5_ce1, "(port)X_R_5_ce1");
    sc_trace(mVcdFile, X_R_5_q1, "(port)X_R_5_q1");
    ...
    sc_trace(mVcdFile, X_I_5_address1, "(port)X_I_5_address1");
    sc_trace(mVcdFile, X_I_5_ce1, "(port)X_I_5_ce1");
    sc_trace(mVcdFile, X_I_5_q1, "(port)X_I_5_q1");
    ...
    sc_trace(mVcdFile, W_real273_address0, "W_real273_address0");
    sc_trace(mVcdFile, W_real273_ce0, "W_real273_ce0");
    sc_trace(mVcdFile, W_real273_q0, "W_real273_q0");
    sc_trace(mVcdFile, W_imag265_address0, "W_imag265_address0");
    sc_trace(mVcdFile, W_imag265_ce0, "W_imag265_ce0");
    sc_trace(mVcdFile, W_imag265_q0, "W_imag265_q0");
    ...
    sc_trace(mVcdFile, select_ln145_9_fu_331_p3, "select_ln145_9_fu_331_p3");
    sc_trace(mVcdFile, select_ln145_9_reg_393, "select_ln145_9_reg_393");
    ...
    sc_trace(mVcdFile, W_real273_load_reg_424, "W_real273_load_reg_424");
    sc_trace(mVcdFile, W_imag265_load_reg_430, "W_imag265_load_reg_430");
    sc_trace(mVcdFile, X_R_5_load_reg_436, "X_R_5_load_reg_436");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter1, "ap_enable_reg_pp0_iter1");
    sc_trace(mVcdFile, X_I_5_load_reg_442, "X_I_5_load_reg_442");
    ...
    sc_trace(mVcdFile, X_R_5_load_1_reg_496, "X_R_5_load_1_reg_496");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter10, "ap_enable_reg_pp0_iter10");
    sc_trace(mVcdFile, X_I_5_load_1_reg_502, "X_I_5_load_1_reg_502");
    ...
    sc_trace(mVcdFile, trunc_ln152_4_fu_305_p1, "trunc_ln152_4_fu_305_p1");
    sc_trace(mVcdFile, k_mid1_fu_309_p3, "k_mid1_fu_309_p3");
    sc_trace(mVcdFile, k_fu_265_p3, "k_fu_265_p3");
    sc_trace(mVcdFile, select_ln145_8_fu_317_p3, "select_ln145_8_fu_317_p3");
...
fft_stage_1241::~fft_stage_1241() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

    delete W_real273_U;
    delete W_imag265_U;
    delete music_fsub_32ns_3bkb_U78;
    delete music_fadd_32ns_3cud_U79;
    delete music_fsub_32ns_3bkb_U80;
    delete music_fsub_32ns_3bkb_U81;
    delete music_fadd_32ns_3cud_U82;
    delete music_fadd_32ns_3cud_U83;
    delete music_fmul_32ns_3dEe_U84;
    delete music_fmul_32ns_3dEe_U85;
    delete music_fmul_32ns_3dEe_U86;
    delete music_fmul_32ns_3dEe_U87;
}

void fft_stage_1241::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void fft_stage_1241::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        j_0_reg_199 = select_ln145_9_reg_393.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln145_reg_374.read(), ap_const_lv1_0))) {
        W_imag265_load_reg_430 = W_imag265_q0.read();
        W_real273_load_reg_424 = W_real273_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln145_reg_374_pp0_iter9_reg.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter10.read()))) {
        X_I_5_load_1_reg_502 = X_I_5_q1.read();
        X_R_5_load_1_reg_496 = X_R_5_q1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln145_reg_374.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()))) {
        X_I_5_load_reg_442 = X_I_5_q0.read();
        X_R_5_load_reg_436 = X_R_5_q0.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(icmp_ln145_fu_273_p2.read(), ap_const_lv1_0))) {
        select_ln145_9_reg_393 = select_ln145_9_fu_331_p3.read();
    }
...
void fft_stage_1241::thread_Out_I_6_address0() {
    Out_I_6_address0 =  (sc_lv<10>) (zext_ln156_reg_403_pp0_iter15_reg.read());
}

void fft_stage_1241::thread_Out_I_6_address1() {
    Out_I_6_address1 =  (sc_lv<10>) (zext_ln158_reg_468_pp0_iter15_reg.read());
}

void fft_stage_1241::thread_Out_I_6_ce0() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
...
void fft_stage_1241::thread_Out_I_6_ce1() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()))) {
...
void fft_stage_1241::thread_Out_I_6_d0() {
    Out_I_6_d0 = tmp_65_reg_513.read();
}

void fft_stage_1241::thread_Out_I_6_d1() {
    Out_I_6_d1 = tmp_67_reg_523.read();
}

void fft_stage_1241::thread_Out_I_6_we0() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()) && 
...
void fft_stage_1241::thread_Out_I_6_we1() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()) && 
         esl_seteq<1,1,1>(icmp_ln145_reg_374_pp0_iter15_reg.read(), ap_const_lv1_0))) {
...
void fft_stage_1241::thread_Out_R_6_address0() {
    Out_R_6_address0 =  (sc_lv<10>) (zext_ln156_reg_403_pp0_iter15_reg.read());
}

void fft_stage_1241::thread_Out_R_6_address1() {
    Out_R_6_address1 =  (sc_lv<10>) (zext_ln158_reg_468_pp0_iter15_reg.read());
}

void fft_stage_1241::thread_Out_R_6_ce0() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()))) {
...
void fft_stage_1241::thread_Out_R_6_ce1() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()))) {
...
void fft_stage_1241::thread_Out_R_6_d0() {
    Out_R_6_d0 = tmp_64_reg_508.read();
}

void fft_stage_1241::thread_Out_R_6_d1() {
    Out_R_6_d1 = tmp_66_reg_518.read();
}

void fft_stage_1241::thread_Out_R_6_we0() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()) && 
         esl_seteq<1,1,1>(icmp_ln145_reg_374_pp0_iter15_reg.read(), ap_const_lv1_0))) {
...
void fft_stage_1241::thread_Out_R_6_we1() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter16.read()) && 
         esl_seteq<1,1,1>(icmp_ln145_reg_374_pp0_iter15_reg.read(), ap_const_lv1_0))) {
...
void fft_stage_1241::thread_W_imag265_address0() {
    W_imag265_address0 =  (sc_lv<9>) (zext_ln145_fu_325_p1.read());
}

void fft_stage_1241::thread_W_imag265_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()))) {
...
void fft_stage_1241::thread_W_real273_address0() {
    W_real273_address0 =  (sc_lv<9>) (zext_ln145_fu_325_p1.read());
}

void fft_stage_1241::thread_W_real273_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()))) {
...
void fft_stage_1241::thread_X_I_5_address0() {
    X_I_5_address0 =  (sc_lv<10>) (zext_ln156_fu_357_p1.read());
}

void fft_stage_1241::thread_X_I_5_address1() {
    X_I_5_address1 =  (sc_lv<10>) (zext_ln158_fu_369_p1.read());
}

void fft_stage_1241::thread_X_I_5_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()))) {
...
void fft_stage_1241::thread_X_I_5_ce1() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
...
void fft_stage_1241::thread_X_R_5_address0() {
    X_R_5_address0 =  (sc_lv<10>) (zext_ln156_fu_357_p1.read());
}

void fft_stage_1241::thread_X_R_5_address1() {
    X_R_5_address1 =  (sc_lv<10>) (zext_ln158_fu_369_p1.read());
}

void fft_stage_1241::thread_X_R_5_ce0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()))) {
...
void fft_stage_1241::thread_X_R_5_ce1() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter9.read()))) {
...
void fft_stage_1241::thread_add_ln145_fu_279_p2() {
...
void fft_stage_1241::thread_ap_CS_fsm_pp0_stage0() {
    ap_CS_fsm_pp0_stage0 = ap_CS_fsm.read()[1];
}

void fft_stage_1241::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void fft_stage_1241::thread_ap_CS_fsm_state19() {
    ap_CS_fsm_state19 = ap_CS_fsm.read()[2];
}

void fft_stage_1241::thread_ap_block_pp0_stage0() {
    ap_block_pp0_stage0 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state1() {
    ap_block_state1 = (esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1));
}

void fft_stage_1241::thread_ap_block_state10_pp0_stage0_iter8() {
    ap_block_state10_pp0_stage0_iter8 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state11_pp0_stage0_iter9() {
    ap_block_state11_pp0_stage0_iter9 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state12_pp0_stage0_iter10() {
    ap_block_state12_pp0_stage0_iter10 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state13_pp0_stage0_iter11() {
    ap_block_state13_pp0_stage0_iter11 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state14_pp0_stage0_iter12() {
    ap_block_state14_pp0_stage0_iter12 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state15_pp0_stage0_iter13() {
    ap_block_state15_pp0_stage0_iter13 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state16_pp0_stage0_iter14() {
    ap_block_state16_pp0_stage0_iter14 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state17_pp0_stage0_iter15() {
    ap_block_state17_pp0_stage0_iter15 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state18_pp0_stage0_iter16() {
    ap_block_state18_pp0_stage0_iter16 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state2_pp0_stage0_iter0() {
    ap_block_state2_pp0_stage0_iter0 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state3_pp0_stage0_iter1() {
    ap_block_state3_pp0_stage0_iter1 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state4_pp0_stage0_iter2() {
    ap_block_state4_pp0_stage0_iter2 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state5_pp0_stage0_iter3() {
    ap_block_state5_pp0_stage0_iter3 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state6_pp0_stage0_iter4() {
    ap_block_state6_pp0_stage0_iter4 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state7_pp0_stage0_iter5() {
    ap_block_state7_pp0_stage0_iter5 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state8_pp0_stage0_iter6() {
    ap_block_state8_pp0_stage0_iter6 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_block_state9_pp0_stage0_iter7() {
    ap_block_state9_pp0_stage0_iter7 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void fft_stage_1241::thread_ap_condition_pp0_exit_iter0_state2() {
...
void fft_stage_1241::thread_ap_done() {
...
void fft_stage_1241::thread_ap_enable_pp0() {
    ap_enable_pp0 = (ap_idle_pp0.read() ^ ap_const_logic_1);
}

void fft_stage_1241::thread_ap_idle() {
...
void fft_stage_1241::thread_ap_idle_pp0() {
...
void fft_stage_1241::thread_ap_phi_mux_j_0_phi_fu_203_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(icmp_ln145_reg_374.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0))) {
        ap_phi_mux_j_0_phi_fu_203_p4 = select_ln145_9_reg_393.read();
    } else {
        ap_phi_mux_j_0_phi_fu_203_p4 = j_0_reg_199.read();
    }
}

void fft_stage_1241::thread_ap_ready() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state19.read())) {
...
void fft_stage_1241::thread_i_fu_343_p3() {
    i_fu_343_p3 = esl_concat<4,6>(trunc_ln149_fu_339_p1.read(), select_ln145_9_fu_331_p3.read());
}

void fft_stage_1241::thread_i_lower_fu_351_p2() {
    i_lower_fu_351_p2 = (!ap_const_lv10_20.is_01() || !i_fu_343_p3.read().is_01())? sc_lv<10>(): (sc_biguint<10>(ap_const_lv10_20) + sc_biguint<10>(i_fu_343_p3.read()));
}

void fft_stage_1241::thread_icmp_ln145_fu_273_p2() {
...
void fft_stage_1241::thread_icmp_ln148_fu_291_p2() {
    icmp_ln148_fu_291_p2 = (!t_0_reg_210.read().is_01() || !ap_const_lv5_10.is_01())? sc_lv<1>(): sc_lv<1>(t_0_reg_210.read() == ap_const_lv5_10);
}

void fft_stage_1241::thread_j_fu_285_p2() {
    j_fu_285_p2 = (!ap_const_lv6_1.is_01() || !ap_phi_mux_j_0_phi_fu_203_p4.read().is_01())? sc_lv<6>(): (sc_biguint<6>(ap_const_lv6_1) + sc_biguint<6>(ap_phi_mux_j_0_phi_fu_203_p4.read()));
}

void fft_stage_1241::thread_k_fu_265_p3() {
    k_fu_265_p3 = esl_concat<5,4>(trunc_ln152_fu_261_p1.read(), ap_const_lv4_0);
}

void fft_stage_1241::thread_k_mid1_fu_309_p3() {
    k_mid1_fu_309_p3 = esl_concat<5,4>(trunc_ln152_4_fu_305_p1.read(), ap_const_lv4_0);
}

void fft_stage_1241::thread_select_ln145_8_fu_317_p3() {
    select_ln145_8_fu_317_p3 = (!icmp_ln148_fu_291_p2.read()[0].is_01())? sc_lv<9>(): ((icmp_ln148_fu_291_p2.read()[0].to_bool())? k_mid1_fu_309_p3.read(): k_fu_265_p3.read());
}

void fft_stage_1241::thread_select_ln145_9_fu_331_p3() {
    select_ln145_9_fu_331_p3 = (!icmp_ln148_fu_291_p2.read()[0].is_01())? sc_lv<6>(): ((icmp_ln148_fu_291_p2.read()[0].to_bool())? j_fu_285_p2.read(): ap_phi_mux_j_0_phi_fu_203_p4.read());
}

void fft_stage_1241::thread_select_ln145_fu_297_p3() {
    select_ln145_fu_297_p3 = (!icmp_ln148_fu_291_p2.read()[0].is_01())? sc_lv<5>(): ((icmp_ln148_fu_291_p2.read()[0].to_bool())? ap_const_lv5_0: t_0_reg_210.read());
}

void fft_stage_1241::thread_t_fu_363_p2() {
    t_fu_363_p2 = (!ap_const_lv5_1.is_01() || !select_ln145_fu_297_p3.read().is_01())? sc_lv<5>(): (sc_biguint<5>(ap_const_lv5_1) + sc_biguint<5>(select_ln145_fu_297_p3.read()));
}

void fft_stage_1241::thread_trunc_ln149_fu_339_p1() {
    trunc_ln149_fu_339_p1 = select_ln145_fu_297_p3.read().range(4-1, 0);
}

void fft_stage_1241::thread_trunc_ln152_4_fu_305_p1() {
    trunc_ln152_4_fu_305_p1 = j_fu_285_p2.read().range(5-1, 0);
}

void fft_stage_1241::thread_trunc_ln152_fu_261_p1() {
    trunc_ln152_fu_261_p1 = ap_phi_mux_j_0_phi_fu_203_p4.read().range(5-1, 0);
}

void fft_stage_1241::thread_zext_ln145_fu_325_p1() {
    zext_ln145_fu_325_p1 = esl_zext<64,9>(select_ln145_8_fu_317_p3.read());
}

void fft_stage_1241::thread_zext_ln156_fu_357_p1() {
    zext_ln156_fu_357_p1 = esl_zext<64,10>(i_lower_fu_351_p2.read());
}

void fft_stage_1241::thread_zext_ln158_fu_369_p1() {
    zext_ln158_fu_369_p1 = esl_zext<64,10>(i_reg_398_pp0_iter8_reg.read());
}

void fft_stage_1241::thread_ap_NS_fsm() {
