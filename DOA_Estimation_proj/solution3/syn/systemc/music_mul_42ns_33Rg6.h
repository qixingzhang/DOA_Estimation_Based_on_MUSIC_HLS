...
// ==============================================================
#ifndef __music_mul_42ns_33Rg6__HH__
#define __music_mul_42ns_33Rg6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_42ns_33Rg6) {
    ...
    SC_CTOR(music_mul_42ns_33Rg6):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
