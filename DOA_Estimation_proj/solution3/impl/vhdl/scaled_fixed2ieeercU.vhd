...
entity scaled_fixed2ieeercU_ram is 
    generic(
...
architecture rtl of scaled_fixed2ieeercU_ram is 
...
entity scaled_fixed2ieeercU is
    generic (
...
architecture arch of scaled_fixed2ieeercU is
    component scaled_fixed2ieeercU_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    scaled_fixed2ieeercU_ram_U :  component scaled_fixed2ieeercU_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
