...
architecture behav of sort_eigval is 
    ...
    signal zext_ln88_fu_330_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal icmp_ln89_fu_380_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_fu_442_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_reg_746 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln95_fu_452_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln95_reg_752 : STD_LOGIC_VECTOR (1 downto 0);
    signal temp_fu_456_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal temp_reg_760 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln90_fu_504_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln90_reg_768 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal icmp_ln90_1_fu_510_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln90_1_reg_773 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln90_2_fu_516_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln90_2_reg_778 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln90_3_fu_522_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln90_3_reg_783 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln87_fu_334_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_0_in_reg_227 : STD_LOGIC_VECTOR (31 downto 0);
    signal phi_ln96_reg_236 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln84_fu_254_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal trunc_ln85_fu_270_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal trunc_ln89_fu_370_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal bitcast_ln90_fu_470_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln90_1_fu_487_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_fu_473_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln90_3_fu_483_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_5_fu_490_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln90_4_fu_500_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal or_ln90_fu_528_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln90_1_fu_532_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln90_fu_536_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_250_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln90_1_fu_542_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    music_fcmp_32ns_3pcA_U156 : component music_fcmp_32ns_3pcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U157 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din3 => zext_ln84_fu_254_p1,
        din4 => trunc_ln85_fu_270_p1,
        dout => sort_index_3_1_fu_274_p6);

    music_mux_42_32_1_1_U158 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din2 => zext_ln84_fu_254_p1,
        din3 => sort_index_2_0_reg_130,
        din4 => trunc_ln85_fu_270_p1,
        dout => sort_index_2_1_fu_288_p6);

    music_mux_42_32_1_1_U159 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U162 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U163 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U164 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U165 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U166 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din3 => phi_ln96_reg_236,
        din4 => trunc_ln95_reg_752,
        dout => sort_index_3_3_fu_555_p6);

    music_mux_42_32_1_1_U167 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din2 => phi_ln96_reg_236,
        din3 => sort_index_2_2_reg_183,
        din4 => trunc_ln95_reg_752,
        dout => sort_index_2_3_fu_568_p6);

    music_mux_42_32_1_1_U168 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U170 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    music_mux_42_32_1_1_U171 : component music_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln87_fu_334_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                flag_0_reg_217 <= zext_ln88_fu_330_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln84_fu_258_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln84_fu_258_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln87_fu_334_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                j_0_in_reg_227 <= zext_ln88_fu_330_p1;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    phi_ln96_reg_236_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln89_fu_380_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                if ((flag_reg_205 = ap_const_lv2_0)) then 
                    phi_ln96_reg_236 <= sort_index_0_2_reg_161;
                elsif ((not((flag_reg_205 = ap_const_lv2_0)) and not((flag_reg_205 = ap_const_lv2_1)))) then 
                    phi_ln96_reg_236 <= sort_index_2_2_reg_183;
                elsif ((flag_reg_205 = ap_const_lv2_1)) then 
                    phi_ln96_reg_236 <= sort_index_1_2_reg_172;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                icmp_ln90_1_reg_773 <= icmp_ln90_1_fu_510_p2;
                icmp_ln90_2_reg_778 <= icmp_ln90_2_fu_516_p2;
                icmp_ln90_3_reg_783 <= icmp_ln90_3_fu_522_p2;
                icmp_ln90_reg_768 <= icmp_ln90_fu_504_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln89_fu_380_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                ...
                trunc_ln95_reg_752 <= trunc_ln95_fu_452_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln89_fu_380_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln84_fu_258_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, icmp_ln89_fu_380_p2, icmp_ln87_fu_334_p2)
    begin
        case ap_CS_fsm is
    ...
    and_ln90_1_fu_542_p2 <= (grp_fu_250_p2 and and_ln90_fu_536_p2);
    and_ln90_fu_536_p2 <= (or_ln90_fu_528_p2 and or_ln90_1_fu_532_p2);
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state3, icmp_ln87_fu_334_p2)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state3, icmp_ln87_fu_334_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1))) then 
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state3, sort_index_0_2_reg_161, icmp_ln87_fu_334_p2, ap_return_0_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1))) then 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state3, sort_index_1_2_reg_172, icmp_ln87_fu_334_p2, ap_return_1_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1))) then 
    ...
    ap_return_2_assign_proc : process(ap_CS_fsm_state3, sort_index_2_2_reg_183, icmp_ln87_fu_334_p2, ap_return_2_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1))) then 
    ...
    ap_return_3_assign_proc : process(ap_CS_fsm_state3, sort_index_3_2_reg_194, icmp_ln87_fu_334_p2, ap_return_3_preg)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln87_fu_334_p2 = ap_const_lv1_1))) then 
    ...
    bitcast_ln90_1_fu_487_p1 <= tmp_3_reg_746;
    bitcast_ln90_fu_470_p1 <= tmp_1_reg_740;
    ...
    icmp_ln84_fu_258_p2 <= "1" when (i_0_reg_150 = ap_const_lv3_4) else "0";
    icmp_ln87_fu_334_p2 <= "1" when (flag_reg_205 = ap_const_lv2_3) else "0";
    icmp_ln89_fu_380_p2 <= "1" when (j_0_in_reg_227 = ap_const_lv32_3) else "0";
    icmp_ln90_1_fu_510_p2 <= "1" when (trunc_ln90_3_fu_483_p1 = ap_const_lv23_0) else "0";
    icmp_ln90_2_fu_516_p2 <= "0" when (tmp_5_fu_490_p4 = ap_const_lv8_FF) else "1";
    icmp_ln90_3_fu_522_p2 <= "1" when (trunc_ln90_4_fu_500_p1 = ap_const_lv23_0) else "0";
    icmp_ln90_fu_504_p2 <= "0" when (tmp_4_fu_473_p4 = ap_const_lv8_FF) else "1";
    j_2_fu_374_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(j_0_in_reg_227));
    j_fu_548_p3 <= 
        j_2_reg_731 when (and_ln90_1_fu_542_p2(0) = '1') else 
        flag_0_reg_217;
    or_ln90_1_fu_532_p2 <= (icmp_ln90_3_reg_783 or icmp_ln90_2_reg_778);
    or_ln90_fu_528_p2 <= (icmp_ln90_reg_768 or icmp_ln90_1_reg_773);
    temp_fu_456_p5 <= flag_0_reg_217(2 - 1 downto 0);
    tmp_1_fu_408_p5 <= tmp_fu_390_p6(2 - 1 downto 0);
    tmp_2_fu_424_p5 <= std_logic_vector(unsigned(ap_const_lv2_1) + unsigned(trunc_ln89_fu_370_p1));
    tmp_3_fu_442_p5 <= tmp_2_fu_424_p6(2 - 1 downto 0);
    tmp_4_fu_473_p4 <= bitcast_ln90_fu_470_p1(30 downto 23);
    tmp_5_fu_490_p4 <= bitcast_ln90_1_fu_487_p1(30 downto 23);
    tmp_fu_390_p5 <= flag_0_reg_217(2 - 1 downto 0);
    trunc_ln85_fu_270_p1 <= i_0_reg_150(2 - 1 downto 0);
    trunc_ln89_fu_370_p1 <= j_0_in_reg_227(2 - 1 downto 0);
    trunc_ln90_3_fu_483_p1 <= bitcast_ln90_fu_470_p1(23 - 1 downto 0);
    trunc_ln90_4_fu_500_p1 <= bitcast_ln90_1_fu_487_p1(23 - 1 downto 0);
    trunc_ln95_fu_452_p1 <= flag_0_reg_217(2 - 1 downto 0);
    zext_ln84_fu_254_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_150),32));
    zext_ln88_fu_330_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(flag_reg_205),32));
end behav;
