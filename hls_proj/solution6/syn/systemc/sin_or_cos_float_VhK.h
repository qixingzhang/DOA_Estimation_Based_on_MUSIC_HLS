...
// ==============================================================
#ifndef __sin_or_cos_float_VhK_H__
#define __sin_or_cos_float_VhK_H__
...
struct sin_or_cos_float_VhK_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sin_or_cos_float_VhK_ram) {
...
SC_MODULE(sin_or_cos_float_VhK) {
...
sin_or_cos_float_VhK_ram* meminst;


SC_CTOR(sin_or_cos_float_VhK) {
meminst = new sin_or_cos_float_VhK_ram("sin_or_cos_float_VhK_ram");
