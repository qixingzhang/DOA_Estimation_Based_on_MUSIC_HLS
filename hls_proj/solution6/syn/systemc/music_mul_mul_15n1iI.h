...
// ==============================================================
#ifndef __music_mul_mul_15n1iI__HH__
#define __music_mul_mul_15n1iI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_mul_15n1iI) {
    ...
    SC_CTOR(music_mul_mul_15n1iI):  ACMP_smul_us_U ("ACMP_smul_us_U") {
