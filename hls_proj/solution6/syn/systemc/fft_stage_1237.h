...
#ifndef _fft_stage_1237_HH_
#define _fft_stage_1237_HH_
...
struct fft_stage_1237 : public sc_module {
    ...
    sc_out< sc_lv<10> > X_R_1_address1;
    sc_out< sc_logic > X_R_1_ce1;
    sc_in< sc_lv<32> > X_R_1_q1;
    sc_out< sc_lv<10> > X_I_1_address0;
    sc_out< sc_logic > X_I_1_ce0;
    sc_in< sc_lv<32> > X_I_1_q0;
    sc_out< sc_lv<10> > X_I_1_address1;
    sc_out< sc_logic > X_I_1_ce1;
    sc_in< sc_lv<32> > X_I_1_q1;
    ...
    // Module declarations
    fft_stage_1237(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_1237);

    ~fft_stage_1237();

    sc_trace_file* mVcdFile;

    fft_stage_1237_W_eOg* W_real277_U;
    fft_stage_1237_W_fYi* W_imag269_U;
    music_fsub_32ns_3bkb<1,5,32,32,32>* music_fsub_32ns_3bkb_U20;
    music_fadd_32ns_3cud<1,5,32,32,32>* music_fadd_32ns_3cud_U21;
    music_fsub_32ns_3bkb<1,5,32,32,32>* music_fsub_32ns_3bkb_U22;
    music_fsub_32ns_3bkb<1,5,32,32,32>* music_fsub_32ns_3bkb_U23;
    music_fadd_32ns_3cud<1,5,32,32,32>* music_fadd_32ns_3cud_U24;
    music_fadd_32ns_3cud<1,5,32,32,32>* music_fadd_32ns_3cud_U25;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U26;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U27;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U28;
    music_fmul_32ns_3dEe<1,4,32,32,32>* music_fmul_32ns_3dEe_U29;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<3> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<9> > W_real277_address0;
    sc_signal< sc_logic > W_real277_ce0;
    sc_signal< sc_lv<32> > W_real277_q0;
    sc_signal< sc_lv<9> > W_imag269_address0;
    sc_signal< sc_logic > W_imag269_ce0;
    sc_signal< sc_lv<32> > W_imag269_q0;
    ...
    sc_signal< sc_lv<2> > select_ln145_21_fu_331_p3;
    sc_signal< sc_lv<2> > select_ln145_21_reg_393;
    ...
    sc_signal< sc_lv<9> > t_fu_363_p2;
    sc_signal< sc_lv<32> > W_real277_load_reg_424;
    sc_signal< sc_lv<32> > W_imag269_load_reg_430;
    sc_signal< sc_lv<32> > X_R_1_load_reg_436;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< sc_lv<32> > X_I_1_load_reg_442;
    ...
    sc_signal< sc_lv<32> > X_R_1_load_1_reg_496;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter10;
    sc_signal< sc_lv<32> > X_I_1_load_1_reg_502;
    ...
    sc_signal< sc_lv<1> > trunc_ln152_fu_261_p1;
    sc_signal< sc_lv<1> > icmp_ln148_fu_291_p2;
    sc_signal< sc_lv<2> > j_fu_285_p2;
    sc_signal< sc_lv<1> > trunc_ln152_8_fu_305_p1;
    sc_signal< sc_lv<9> > k_mid1_fu_309_p3;
    sc_signal< sc_lv<9> > k_fu_265_p3;
    sc_signal< sc_lv<9> > select_ln145_20_fu_317_p3;
    sc_signal< sc_lv<9> > select_ln145_fu_297_p3;
    sc_signal< sc_lv<8> > trunc_ln149_fu_339_p1;
    ...
    void thread_W_imag269_address0();
    void thread_W_imag269_ce0();
    void thread_W_real277_address0();
    void thread_W_real277_ce0();
    void thread_X_I_1_address0();
    void thread_X_I_1_address1();
    void thread_X_I_1_ce0();
    void thread_X_I_1_ce1();
    void thread_X_R_1_address0();
    void thread_X_R_1_address1();
    void thread_X_R_1_ce0();
    void thread_X_R_1_ce1();
    ...
    void thread_select_ln145_20_fu_317_p3();
    void thread_select_ln145_21_fu_331_p3();
    void thread_select_ln145_fu_297_p3();
    void thread_t_fu_363_p2();
    void thread_trunc_ln149_fu_339_p1();
    void thread_trunc_ln152_8_fu_305_p1();
