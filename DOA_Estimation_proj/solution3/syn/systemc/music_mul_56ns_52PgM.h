...
// ==============================================================
#ifndef __music_mul_56ns_52PgM__HH__
#define __music_mul_56ns_52PgM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_56ns_52PgM) {
    ...
    SC_CTOR(music_mul_56ns_52PgM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
