...
HD_PWD='C:/Users/zhangqx/workspace/Xilinx_Intern/summer/project/DOA_Estimation_Based_on_MUSIC_HLS/vivado_proj/vivado_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log music_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source music_wrapper.tcl -notrace
