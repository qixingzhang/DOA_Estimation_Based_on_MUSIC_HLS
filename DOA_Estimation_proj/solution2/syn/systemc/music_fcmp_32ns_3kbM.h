...
// ==============================================================
#ifndef __music_fcmp_32ns_3kbM__HH__
#define __music_fcmp_32ns_3kbM__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fcmp_32ns_3kbM) {
    ...
    SC_CTOR(music_fcmp_32ns_3kbM):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
