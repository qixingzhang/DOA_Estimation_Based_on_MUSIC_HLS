...
// ==============================================================
#ifndef __music_fptrunc_64nIfE__HH__
#define __music_fptrunc_64nIfE__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fptrunc_64nIfE) {
    ...
    SC_CTOR(music_fptrunc_64nIfE):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
