...
// ==============================================================
#ifndef __music_fptrunc_64nbil__HH__
#define __music_fptrunc_64nbil__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fptrunc_64nbil) {
    ...
    SC_CTOR(music_fptrunc_64nbil):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
