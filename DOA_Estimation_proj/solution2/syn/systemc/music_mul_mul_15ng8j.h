...
// ==============================================================
#ifndef __music_mul_mul_15ng8j__HH__
#define __music_mul_mul_15ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_mul_15ng8j) {
    ...
    SC_CTOR(music_mul_mul_15ng8j):  ACMP_smul_us_U ("ACMP_smul_us_U") {
