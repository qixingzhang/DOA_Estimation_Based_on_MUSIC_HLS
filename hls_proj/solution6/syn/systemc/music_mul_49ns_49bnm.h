...
// ==============================================================
#ifndef __music_mul_49ns_49bnm__HH__
#define __music_mul_49ns_49bnm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_49ns_49bnm) {
    ...
    SC_CTOR(music_mul_49ns_49bnm):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
