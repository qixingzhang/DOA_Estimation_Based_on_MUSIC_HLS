...
// ==============================================================
#ifndef __music_sitodp_32nsMgi__HH__
#define __music_sitodp_32nsMgi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_sitodp_32nsMgi) {
    ...
    SC_CTOR(music_sitodp_32nsMgi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
