...
// ==============================================================
#ifndef __music_mul_mul_15njbC__HH__
#define __music_mul_mul_15njbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_mul_15njbC) {
    ...
    SC_CTOR(music_mul_mul_15njbC):  ACMP_smul_us_U ("ACMP_smul_us_U") {
