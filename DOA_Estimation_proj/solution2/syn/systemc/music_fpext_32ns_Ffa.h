...
// ==============================================================
#ifndef __music_fpext_32ns_Ffa__HH__
#define __music_fpext_32ns_Ffa__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fpext_32ns_Ffa) {
    ...
    SC_CTOR(music_fpext_32ns_Ffa):  ACMP_fpext_U ("ACMP_fpext_U") {
