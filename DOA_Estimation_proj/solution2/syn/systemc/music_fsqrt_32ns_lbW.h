...
// ==============================================================
#ifndef __music_fsqrt_32ns_lbW__HH__
#define __music_fsqrt_32ns_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fsqrt_32ns_lbW) {
    ...
    SC_CTOR(music_fsqrt_32ns_lbW):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
