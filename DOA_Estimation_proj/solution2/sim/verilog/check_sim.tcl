...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.music.autotvin_X.dat"
         "c.music.autotvin_Xj_f_M_real.dat"
         "c.music.autotvin_Xj_f_M_imag.dat"
         "c.music.autotvin_P_sm.dat"
         "c.music.autotvout_Xj_f_M_real.dat"
         "c.music.autotvout_Xj_f_M_imag.dat"
         "c.music.autotvout_P_sm.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.music.autotvout_Xj_f_M_real.dat"
         "rtl.music.autotvout_Xj_f_M_imag.dat"
         "rtl.music.autotvout_P_sm.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
