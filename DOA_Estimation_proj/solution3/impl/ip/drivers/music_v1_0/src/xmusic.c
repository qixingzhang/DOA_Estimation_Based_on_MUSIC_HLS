...
u32 XMusic_Get_return(XMusic *InstancePtr) {
    ...
    Data = XMusic_ReadReg(InstancePtr->Axilites_BaseAddress, XMUSIC_AXILITES_ADDR_AP_RETURN);
    return Data;
}
void XMusic_Set_data_re(XMusic *InstancePtr, u32 Data) {
    ...
    XMusic_WriteReg(InstancePtr->Axilites_BaseAddress, XMUSIC_AXILITES_ADDR_DATA_RE_DATA, Data);
}
...
u32 XMusic_Get_data_re(XMusic *InstancePtr) {
    ...
    Data = XMusic_ReadReg(InstancePtr->Axilites_BaseAddress, XMUSIC_AXILITES_ADDR_DATA_RE_DATA);
    return Data;
}
...
void XMusic_Set_data_im(XMusic *InstancePtr, u32 Data) {
    ...
    XMusic_WriteReg(InstancePtr->Axilites_BaseAddress, XMUSIC_AXILITES_ADDR_DATA_IM_DATA, Data);
}
...
u32 XMusic_Get_data_im(XMusic *InstancePtr) {
    ...
    Data = XMusic_ReadReg(InstancePtr->Axilites_BaseAddress, XMUSIC_AXILITES_ADDR_DATA_IM_DATA);
    return Data;
}

u32 XMusic_Get_P_sm_BaseAddress(XMusic *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XMUSIC_AXILITES_ADDR_P_SM_BASE);
}

u32 XMusic_Get_P_sm_HighAddress(XMusic *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XMUSIC_AXILITES_ADDR_P_SM_HIGH);
}

u32 XMusic_Get_P_sm_TotalBytes(XMusic *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XMUSIC_AXILITES_ADDR_P_SM_HIGH - XMUSIC_AXILITES_ADDR_P_SM_BASE + 1);
}

u32 XMusic_Get_P_sm_BitWidth(XMusic *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XMUSIC_AXILITES_WIDTH_P_SM;
}

u32 XMusic_Get_P_sm_Depth(XMusic *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XMUSIC_AXILITES_DEPTH_P_SM;
}

u32 XMusic_Write_P_sm_Words(XMusic *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XMUSIC_AXILITES_ADDR_P_SM_HIGH - XMUSIC_AXILITES_ADDR_P_SM_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XMUSIC_AXILITES_ADDR_P_SM_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XMusic_Read_P_sm_Words(XMusic *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XMUSIC_AXILITES_ADDR_P_SM_BASE + (offset + i)*4);
    }
    return length;
}

u32 XMusic_Write_P_sm_Bytes(XMusic *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XMUSIC_AXILITES_ADDR_P_SM_HIGH - XMUSIC_AXILITES_ADDR_P_SM_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XMUSIC_AXILITES_ADDR_P_SM_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XMusic_Read_P_sm_Bytes(XMusic *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XMUSIC_AXILITES_ADDR_P_SM_BASE + offset + i);
    }
    return length;
}
