...
HD_PWD='C:/Users/zhangqx/workspace/Xilinx_Intern/summer/project/DOA_Estimation_Based_on_MUSIC_HLS/vivado_proj/vivado_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log music_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source music_wrapper.tcl
