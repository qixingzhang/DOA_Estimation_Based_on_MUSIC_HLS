...
// ==============================================================
#ifndef __music_fpext_32ns_bjl__HH__
#define __music_fpext_32ns_bjl__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fpext_32ns_bjl) {
    ...
    SC_CTOR(music_fpext_32ns_bjl):  ACMP_fpext_U ("ACMP_fpext_U") {
