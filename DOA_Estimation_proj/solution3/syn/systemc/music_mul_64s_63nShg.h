...
// ==============================================================
#ifndef __music_mul_64s_63nShg__HH__
#define __music_mul_64s_63nShg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_64s_63nShg) {
    ...
    SC_CTOR(music_mul_64s_63nShg):  ACMP_mul_su_U ("ACMP_mul_su_U") {
