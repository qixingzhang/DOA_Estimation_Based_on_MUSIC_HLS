...
// ==============================================================
#ifndef __music_fsqrt_32ns_Rg6__HH__
#define __music_fsqrt_32ns_Rg6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fsqrt_32ns_Rg6) {
    ...
    SC_CTOR(music_fsqrt_32ns_Rg6):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
