...
#ifndef _fft_stage_123_HH_
#define _fft_stage_123_HH_
...
struct fft_stage_123 : public sc_module {
    ...
    // Module declarations
    fft_stage_123(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_123);

    ~fft_stage_123();

    sc_trace_file* mVcdFile;

    fft_stage_119_W_rfYi* W_real38_U;
    fft_stage_119_W_ig8j* W_imag29_U;
    music_faddfsub_32bkb<1,5,32,32,32>* music_faddfsub_32bkb_U55;
    music_fsub_32ns_3cud<1,5,32,32,32>* music_fsub_32ns_3cud_U56;
    music_fadd_32ns_3dEe<1,5,32,32,32>* music_fadd_32ns_3dEe_U57;
    music_fmul_32ns_3eOg<1,4,32,32,32>* music_fmul_32ns_3eOg_U58;
    music_fmul_32ns_3eOg<1,4,32,32,32>* music_fmul_32ns_3eOg_U59;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<9> > W_real38_address0;
    sc_signal< sc_logic > W_real38_ce0;
    sc_signal< sc_lv<32> > W_real38_q0;
    sc_signal< sc_lv<9> > W_imag29_address0;
    sc_signal< sc_logic > W_imag29_ce0;
    sc_signal< sc_lv<32> > W_imag29_q0;
    ...
    sc_signal< sc_lv<5> > select_ln181_fu_289_p3;
    sc_signal< sc_lv<5> > select_ln181_reg_373;
    sc_signal< sc_lv<6> > select_ln181_9_fu_323_p3;
    sc_signal< sc_lv<6> > select_ln181_9_reg_388;
    ...
    sc_signal< sc_lv<32> > W_real38_load_reg_414;
    sc_signal< sc_lv<32> > W_imag29_load_reg_419;
    sc_signal< sc_lv<32> > X_R_load_reg_424;
    sc_signal< sc_lv<32> > X_I_load_reg_430;
    sc_signal< sc_lv<5> > t_fu_355_p2;
    sc_signal< sc_lv<5> > t_reg_436;
    ...
    sc_signal< sc_lv<5> > ap_phi_mux_t_0_phi_fu_214_p4;
    ...
    sc_signal< sc_lv<5> > trunc_ln190_fu_253_p1;
    sc_signal< sc_lv<1> > icmp_ln184_fu_283_p2;
    sc_signal< sc_lv<6> > j_fu_277_p2;
    sc_signal< sc_lv<5> > trunc_ln190_4_fu_297_p1;
    sc_signal< sc_lv<9> > k_mid1_fu_301_p3;
    sc_signal< sc_lv<9> > k_fu_257_p3;
    sc_signal< sc_lv<9> > select_ln181_8_fu_309_p3;
    sc_signal< sc_lv<4> > trunc_ln187_fu_331_p1;
    ...
    void thread_W_imag29_address0();
    void thread_W_imag29_ce0();
    void thread_W_real38_address0();
    void thread_W_real38_ce0();
    ...
    void thread_select_ln181_8_fu_309_p3();
    void thread_select_ln181_9_fu_323_p3();
    void thread_select_ln181_fu_289_p3();
    void thread_t_fu_355_p2();
    void thread_trunc_ln187_fu_331_p1();
    void thread_trunc_ln190_4_fu_297_p1();
