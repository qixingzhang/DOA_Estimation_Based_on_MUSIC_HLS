...
entity scaled_fixed2ieeeqcK_ram is 
    generic(
...
architecture rtl of scaled_fixed2ieeeqcK_ram is 
...
entity scaled_fixed2ieeeqcK is
    generic (
...
architecture arch of scaled_fixed2ieeeqcK is
    component scaled_fixed2ieeeqcK_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    scaled_fixed2ieeeqcK_ram_U :  component scaled_fixed2ieeeqcK_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
