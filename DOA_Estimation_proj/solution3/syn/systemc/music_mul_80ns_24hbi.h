...
// ==============================================================
#ifndef __music_mul_80ns_24hbi__HH__
#define __music_mul_80ns_24hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_80ns_24hbi) {
    ...
    SC_CTOR(music_mul_80ns_24hbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
