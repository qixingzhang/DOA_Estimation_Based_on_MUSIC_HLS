...
struct sin_or_cos_float_s : public sc_module {
    ...
    music_mul_80ns_24hbi<1,5,80,24,104>* music_mul_80ns_24hbi_U5;
    ...
    music_mul_mul_15njbC<1,1,15,15,30>* music_mul_mul_15njbC_U10;
