...
// ==============================================================
#ifndef __music_fptrunc_64nEe0__HH__
#define __music_fptrunc_64nEe0__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_fptrunc_64nEe0) {
    ...
    SC_CTOR(music_fptrunc_64nEe0):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
