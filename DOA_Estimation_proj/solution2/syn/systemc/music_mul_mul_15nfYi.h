...
// ==============================================================
#ifndef __music_mul_mul_15nfYi__HH__
#define __music_mul_mul_15nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(music_mul_mul_15nfYi) {
    ...
    SC_CTOR(music_mul_mul_15nfYi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
